...
/**
 * EXAM PORTAL LAYOUT - CRASH-PROOF DESIGN
 * 
 * NO useEffect redirects
 * NO auto-redirect loops
 * 
 * On mount:
 * 1. Call checkAuth() to verify session with server
 * 2. If session valid → render page
 * 3. If session invalid → show "Session Expired" message with login link
 * 
 * User MANUALLY clicks to login - no automatic redirect
 */
